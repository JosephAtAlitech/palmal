<?php
	...
	if(isset($_POST['addCustomer'])){
		...
		$sql = "INSERT INTO admin (username,branch_id,password,firstname,lastname,photo,created_on,status,mobile,email) 
				VALUES ('$userName','$branceNumber','$password','$fCustomerName','$lContactPerson','$regfilename',Now(),'1',$PhoneNumber,'$EmailAddress')";
		if($conn->query($sql)){
...
if(isset($_POST['updateCustomer'])){
		...
		$sql = "update admin set username='$userName',branch_id='$branceNumber',firstname='$fCustomerName',lastname='$lContactPerson',mobile='$PhoneNumber',email='$EmailAddress' where id='$uid'";
		if($conn->query($sql)){
