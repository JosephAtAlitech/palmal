...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Live Nearest Tracking Information
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Live Nearest Information</li>
      </ol>
    </section>
    <!-- Main content -->
					...
					<div class="col-md-9">
						...
						<div id="map"></div>
							...
							<div class="col-md-7">
								...
								<select class="form-control" id='units'><option value='0'>~~ Select Unit ~~</option></select>
							</div>
							<div class="col-md-5">
							<label></label><br>
							   <button class="form-control" type="button" id='find-by-unit-button'>Find nearest to the unit</button>
							</div><br><br><br><br>
						<table id='results-table' class="table table-bordered"><thead><tr>
						  <td>Distance</td>
						  <td>Name</td>
						  <td>Last message</td>
						</tr></thead>
						...
						<div class="col-md-7">
						<label>Maximum units count:</label>
							<select class="form-control" id='max-units'><option>5</option><option>10</option><option>20</option></select></p>
						</div>
						<div class="col-md-5">
						<label>Filter by actuality:</label>
						  <select  class="form-control" id='last-message-time-filter'>
