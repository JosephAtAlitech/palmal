...
class MYPDF extends TCPDF {
    ...
    $content .= '<style>p{color:black;font-size: 8px;text-align:center;}
		...
		<table border="1" cellspacing="0" cellpadding="3">
			...
			$sql = "SELECT tbl_purchase.purchaseOrderNo,tbl_purchase.purchaseDate,tbl_purchase.discount,tbl_purchase.paidAmount,tbl_purchase.purchaseType,tbl_purchaseProducts.manufacturingDate,tbl_purchaseProducts.expiryDate,tbl_warehouse.wareHouseName,
		...
		while($row12 = $query->fetch_assoc()){
			...
			$grandTotal+=$total;
			$totalDiscount=$row12['discount'];
			$totalpaidAmount=$row12['paidAmount'];
			$GrandTotalBlance = ($grandTotal-$totalDiscount);
			$content .= '<tr>
			...
			$content .='
				...
				<table>
					...
					<tr>
						...
						<td width="20%" class="citiestd14">Sub-Total amount :</td><td width="10%" class="citiestd14">'.number_format($grandTotal,2).'</td>
					</tr>
					<tr>
						<td width="70%"></td>
				...
				if($totalpaidAmount > 0){
				    $content .='<tr>
						<td width="70%"></td>
						<td width="20%" class="citiestd14">Paid Amount :</td><td width="10%" class="citiestd14">'.number_format($totalpaidAmount, 2).'</td>
					</tr>';
				}
