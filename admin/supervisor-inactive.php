          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example_company" class="table table-bordered">
                ...
                <tbody>
                  <?php
						$sql = "SELECT * FROM `supervisor_master` WHERE status='In-Active'  ORDER BY `supervisor_master`.`id`  DESC";
                    ...
                    while($row = $query->fetch_assoc()){
                        ...
                        <tr>
							...
							<td>".$row['status']."</td>
							<td style='width: 10%;'>
								<button class='btn btn-success btn-sm activeSupervisor btn-flat' data-id='".$row['id']."'><i class='fa fa-trash'></i> Active </button>
							</td>
                        </tr>
                      ";
					}
...
$(function(){
  $('.activeSupervisor').click(function(e){
    e.preventDefault();
    $('#activeSupervisor').modal('show');
    var id = $(this).data('id');
    getRow(id);
  });
