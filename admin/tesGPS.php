	...
	var unit_id =  $("#units").val(),
		...
		callback =  qx.lang.Function.bind(function(code, layer) {
			...
			if (layer) { 
				...
				msg(text +="<td>Location of Unit :" + shoaib +"</td>" )});
				
				var text = "<tr id='" + unit_id + "'>";  
				// print message with information about selected unit and its position
				text += "<td class='unit'><img src='" + unit.getIconUrl(32) + "'/> " + unit.getName() + "</td>"; 
				text += "<td>Mileage :" + layer.getMileage().toFixed(2) + " Km <br> Speed :" + pos.s + "<br> Last Message :" + time + "</td>";
