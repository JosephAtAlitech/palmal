...
$content .= ' <br><br>
      	<p align="center"></p><br>
		<div class="cities"> CS Details </div> <br>
	...
	while ($row10 = $query1->fetch_assoc()) {
		...
		$content .= '<thead>
						<tr>
							...
							<th class="citiestd13" width="11%" >Unit price</th>
							<th class="citiestd13" width="11%" >Total amount</th>
							<th class="citiestd13" width="11%" >Wing head unit</th>
							<th class="citiestd13" width="11%" >Wing head total</th>
							<th class="citiestd13" width="10%" >Audit unit</th>
							<th class="citiestd13" width="10%" >Audit total</th>
						</tr>
					</thead>
					<tbody>';
		$i = 1;
		...
		while ($row12 = $query->fetch_assoc()) {
			...
			$content .= '<tr>
						...
						<td class="citiestd12" width="11%">' . $row12['total_amount'] . '</td>
						<td class="citiestd12" width="11%">' . $row12['wing_head_unit_price'] . ' </td>
						<td class="citiestd12" width="11%">' . $row12['wing_head_total_amount'] . '</td>
		...
		$content .= '
		<tr><td></td><td class="citiestd13">Total</td><td class="citiestd13">'.$unitTotal.'</td><td></td><td class="citiestd12">'.number_format($unitTotaltotal_amount,2).'</td><td></td><td class="citiestd12">'.number_format($unitTotalwing_head_total_amount,2).'</td><td></td><td class="citiestd12">'.number_format($unitTotalaudit_total_amount,2).'</td></tr>
