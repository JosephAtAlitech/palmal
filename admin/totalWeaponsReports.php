...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Weapons Reports Information
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Weapons Reports Information</li>
      </ol>
    </section>
    <!-- Main content -->
                ...
                <tbody>
                  <?php
                    $sql = "SELECT product.id,product.type,product.ranks,product.product_image,product.brand_id,product.categories_id,SUM(product.quantity) AS quantity,
                            ...
                            WHERE product.type='Weapons' GROUP BY categories.categories_name";
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                        <tr>
                          ...
                          <td style='width: 10%;'>
                            <a href='weaponsHistory-viewpdf.php?catName=".$row['categories_name']."&brandId=".$row['brand_name']."&type=".$row['type']."' target='_blank' title='Print' data-toggle='tooltip' class='btn btn-primary btn-sm btn-flat'><i class='fa fa-print'> Print </i></a>
                          </td>
                        </tr>
                      ";
                    }
