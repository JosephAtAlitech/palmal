...
<script type='text/javascript'>
	...
	$.ajax({ 
			type: "POST",
			url :"vehecleWiseCostingReportView.php",
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
		<h1>
			Vehicle Wise Costing Reports 
		</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Vehicle Wise Costing Reports </li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
			<div class="box">
				...
				<h4 style="color: gray;text-align: center;"> Vehicle Wise Costing Reports </h4><hr>
					<div class="col-md-12">
						<form  class="form-horizontal" method="POST">
							<div class="col-sm-3">
								<select class="form-control"  id="vehicleNumber" name="vehicleNumber" required>
									<?php
									  $sql = "SELECT trip_sheets.id,trip_sheets.trip_number,trip_sheets.vehicle_no,vehicle_master.vehicle_number
											FROM `trip_sheets`  
											LEFT JOIN vehicle_master ON vehicle_master.id=trip_sheets.vehicle_no GROUP BY trip_sheets.vehicle_no";
									  $query = $conn->query($sql);
									  while($prow = $query->fetch_assoc()){
										echo "
										  <option value='".$prow['vehicle_no']."'> Vehicle Number : ".$prow['vehicle_number']."</option>
										";
									  }
									?>
								</select>
