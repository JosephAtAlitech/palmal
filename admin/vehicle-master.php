          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example_company" class="table table-bordered">
                ...
                <tbody>
                  <?php
						$sql = "SELECT vehicle_master.id,vehicle_master.wUnitID,vehicle_master.v_type,vehicle_master.vehicle_number,vehicle_master.oil_tank_capacity,vehicle_master.delete_status,vehicle_master.purchase_date,manufacturer_name.name,vehicle_master.year_of_manufacture,
                    ...
                    while($row = $query->fetch_assoc()){
                        ...
                        <tr>
							<td>".$idNo++."</td>
							<td><b>VFT</b> : ".$row['wUnitID']."</td>
							<td><b>Vno</b> : ".$row['vehicle_number']." / ".$row['name']."<br><b>Fuel</b> : ".$row['oil_tank_capacity']." L<br><b>Cno</b> : ".$row['chasis_number']."<br><b>Eno</b> : ".$row['engin_number']."<br><b>Manufacture</b> : ".$row['year_of_manufacture']."</td>
							<td><b>Branch</b> : ".$row['branch_name']."<br><b>Purchase</b> : ".$row['purchase_date']."<br><b>Insert</b> : ".$row['create_date']."</td>
