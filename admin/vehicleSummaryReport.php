...
<script type='text/javascript'>
	...
	$.ajax({ 
			type: "POST",
			url :"vehecleWiseSummaryReportView.php",
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
		<h1>
			Vehicle Wise Summary Reports 
		</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Vehicle Wise Summary Reports </li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
			<div class="box">
				...
				<h4 style="color: gray;text-align: center;"> Vehicle Wise Summary Reports </h4><hr>
					<div class="col-md-12">
