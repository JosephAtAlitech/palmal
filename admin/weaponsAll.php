          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example_company" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT product.id,product.type,product.ranks,product.product_image,product.brand_id,product.categories_id,SUM(product.quantity) AS quantity,		brands.brand_type,brands.brand_name,categories.categories_type,categories.categories_name
							FROM `product` 
							LEFT JOIN brands ON brands.id=product.brand_id
							LEFT JOIN categories ON categories.id=product.categories_id
                            GROUP by categories.categories_name,product.type";
